...
def train_and_save_model(data_path, model_dir, model_type='random_forest'):
    ...
    if model_type == 'random_forest':
        ...
        model_name = "RandomForestRecommender"
    else:
...
if __name__ == "__main__":
    # Train the first model (Random Forest on snapshot 1)
    print("\n=== Training Model 1: Random Forest on Snapshot 1 ===")
    model1_metadata = train_and_save_model(
        './datasets/streaming_data_snapshot1.csv',
        './models/model_snapshot1',
